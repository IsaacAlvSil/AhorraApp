...
export default function MenuScreen() {
  ...
  switch (screen) {
    ...
    case 'nuevaTransaccion':
      return <NuevaTransaccionScreen setScreen={setScreen} />;

    case 'detalles':
      return <DetallesTransaccionScreen setScreen={setScreen} />;

    case 'graficas':
      return <GraficasScreen setScreen={setScreen}/>;

    case 'filtrado':
      return <FiltradoScreen setScreen={setScreen} />;
